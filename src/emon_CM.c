...
static void    calibrationPhase(CTCfg_t *pCfgCT, const VCfg_t *pCfgV,
                                const size_t idxCT, const bool vChan2);
static void    configChannelV(const size_t ch);
static void    configChannelCT(const size_t ch);
...
void configChannelCT(const size_t ch) {
...
void configChannelV(const size_t ch) {
 ...
 *  @param [in] vChan2 : true for 2nd V channel (L-L loads)
 */
static void calibrationPhase(CTCfg_t *pCfgCT, const VCfg_t *pCfgV,
                             const size_t idxCT, const bool vChan2) {

  const size_t idxV  = !vChan2 ? pCfgCT->vChan1 : pCfgCT->vChan2;
  const size_t idxPh = !vChan2 ? 0u : 1u;
